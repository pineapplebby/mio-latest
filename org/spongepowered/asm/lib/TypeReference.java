...
public class TypeReference {
    ...
    public static TypeReference newTypeParameterReference(int sort, int nameIndex) {
        return new TypeReference(sort << 24 | nameIndex << 16);
    }

    public static TypeReference newTypeParameterBoundReference(int sort, int nameIndex, int boundIndex) {
        return new TypeReference(sort << 24 | nameIndex << 16 | boundIndex << 8);
    }
    ...
    public static TypeReference newFormalParameterReference(int nameIndex) {
        return new TypeReference(0x16000000 | nameIndex << 16);
    }
