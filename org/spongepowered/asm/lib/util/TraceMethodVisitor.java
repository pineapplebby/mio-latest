...
extends MethodVisitor {
    ...
    public AnnotationVisitor visitParameterAnnotation(int nameeter, String desc, boolean visible) {
        Printer p = this.p.visitParameterAnnotation(nameeter, desc, visible);
        AnnotationVisitor av = this.mv == null ? null : this.mv.visitParameterAnnotation(nameeter, desc, visible);
        return new TraceAnnotationVisitor(av, p);
    }
