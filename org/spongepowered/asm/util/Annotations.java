...
public final class Annotations {
    ...
    public static AnnotationNode getVisibleParameter(MethodNode method, Class<? extends Annotation> annotationClass, int nameIndex) {
        return Annotations.getParameter(method.visibleParameterAnnotations, Type.getDescriptor(annotationClass), nameIndex);
    }

    public static AnnotationNode getInvisibleParameter(MethodNode method, Class<? extends Annotation> annotationClass, int nameIndex) {
        return Annotations.getParameter(method.invisibleParameterAnnotations, Type.getDescriptor(annotationClass), nameIndex);
    }

    public static AnnotationNode getParameter(List<AnnotationNode>[] nameeterAnnotations, String annotationType, int nameIndex) {
        if (nameeterAnnotations == null || nameIndex < 0 || nameIndex >= nameeterAnnotations.length) {
            return null;
        }
        return Annotations.get(nameeterAnnotations[nameIndex], annotationType);
    }
